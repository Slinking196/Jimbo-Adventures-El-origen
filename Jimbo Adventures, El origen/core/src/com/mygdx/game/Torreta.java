...
public class Torreta {
	...
	public Torreta(Texture img, float x, float y, float width, float height, float coolDown,String view) {
		this.width = width;
		this.height = height;
	...
	private void createTorreta(float x, float y) {
		torretaDef = new BodyDef();
	...
	public void setTorretaWorld(World world) {
	...
	public void update(float delta, World world) {
		...
		if(TimeUtils.nanoTime() - lastBullet > coolDown/*100000000*/) {
			balas.agregarBala(new Texture("Bala.png"), world, pos.x, pos.y, width, height , right, left, up, down);
